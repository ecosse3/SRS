...
import pl.edu.wat.wel.config.audit.AuditEventConverter;
import pl.edu.wat.wel.domain.PersistentAuditEvent;
...
import static pl.edu.wat.wel.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

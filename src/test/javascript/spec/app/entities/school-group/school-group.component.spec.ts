...
import { SchoolGroupComponent } from 'app/entities/school-group/school-group.component';
...
describe('Component Tests', () => {
  describe('SchoolGroup Management Component', () => {
    let comp: SchoolGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SchoolGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.schoolGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
